...
// 7. Chart.js Dashboard Visualizations
function initCharts() {
    const distCanvas = document.getElementById('chartProbDist');
    const deptCanvas = document.getElementById('chartDeptRisk');
    ...
    if (distCanvas && typeof Chart !== 'undefined') {
        new Chart(distCanvas.getContext('2d'), {
            ...
            data: {
                ...
                datasets: [
                    { label: 'Low Risk', data: [450, 380, 210, 80, 0, 0, 0, 0, 0, 0], backgroundColor: '#006c49' },
                    { label: 'Medium Risk', data: [0, 0, 0, 120, 95, 60, 0, 0, 0, 0], backgroundColor: '#f49d09' },
                    { label: 'High Risk', data: [0, 0, 0, 0, 0, 20, 35, 15, 8, 4], backgroundColor: '#ba1a1a' }
                ]
            },
            options: {
                responsive: true,
        ...
        new Chart(deptCanvas.getContext('2d'), {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [20.6, 19.0, 13.8],
                    backgroundColor: ['#1f108e', '#3730a3', '#544fc0'],
                    borderRadius: 6
                }]
            },
            options: {
